---
title: "Biodiversity component documentation"
author: "Katrina Szetey"
date: "31/01/2022"
bibliography: biod.bib
...
mermaid("
graph LR
A(Cultural burning)-->D{Species richness}  
B(Land use change)-->D{Species richness} 
C(Invasive species)-->D{Species richness}
E(Climate damage)-->D{Species richness}
F(Fire impact)-->D{Species richness}
        ")
...
Type: Auxiliary  
Formula: Forest Land + Protected Land  
Units: hectares  
...
Type: Auxiliary  
Formula: (impact of climate damage on biodiversity) * (invasive species impact discrepancy / simulation time) * fire impact on biodiversity  
Units: species/Year  
Assumptions:  
