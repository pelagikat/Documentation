...
digraph {
  ...
  'Housing supply'; 'Tourism housing'; 'Residential housing'; 'Social housing'

  node[shape = oval, fontname = Arial]
  'Wastewater infrastructure'; 'Housing construction'; 'Tourists'; 'Population'; 'Housing stress'

  # edge statements
  'Wastewater infrastructure'->'Housing construction' 'Housing construction'->'Housing supply'
  'Tourists'->'Tourism housing' 'Housing supply'->'Tourism housing'
  'Tourism housing'->'Residential housing' 'Housing supply'->'Residential housing'
  'Population'->'Residential housing' 'Residential housing'->'Housing stress'
   'Housing stress'->'Social housing'
