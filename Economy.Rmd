---
title: "Economy component documentation"
author: "Katrina Szetey"
date: "02/02/2022"
bibliography: Econrefs.bib
...
Y = AL^β K^c
$$
where Y = total production (value of goods produced) each year, A = productivity factor, L = labour input, K = capital input, and α and β are output elasticities of capital and labour, respectively.
...
A(Productivity multipliers)-->B{Productivity Y}
C(Productivity factor A)-->B{Productivity Y}
D(Labour input L)-->B{Productivity Y}
E(Capital input K)-->B{Productivity Y}
F(Elasticities α, β)-->B{Productivity Y}
